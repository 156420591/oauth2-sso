  ...
  SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
    ...
    http.authorizeExchange(
            exchanges ->
                exchanges
                    .pathMatchers("/role")
                    .access(AuthorityReactiveAuthorizationManager.hasAnyScope("ADMIN"))
                    //                    .hasAnyRole("ADMIN")
                    .pathMatchers("/auth")
                    .access(AuthorityReactiveAuthorizationManager.hasScope("SCOPE_TEST"))
                    //                    .hasAnyAuthority("SCOPE_TEST")
                    .anyExchange()
